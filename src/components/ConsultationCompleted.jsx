...
function ConsultationCompleted(_ref) {
    var visitData = _ref.visitData, onClose = _ref.onClose;
    ...
    var handleDownloadToken = function handleDownloadToken() {
        _reactNative.Alert.alert(t('ccDownloadAlertTitle') || 'Download', t('ccDownloadAlertMsg') || 'Token details downloaded to device.');
    };
    ...
    return (/*#__PURE__*/
        (0, _jsxRuntime.jsxs)(_reactNative.ScrollView, {
            contentContainerStyle: styles.container, children: [/*#__PURE__*/
                        ...
                        (0, _jsxRuntime.jsxs)(_card.CardHeader, {
                            style: styles.row, children: [/*#__PURE__*/
                                (0, _jsxRuntime.jsx)(_button.Button, {
                                    variant: "ghost", size: "sm", onPress: handleBackToDashboard, style: { marginRight: 8 }, children:/*#__PURE__*/
                                        (0, _jsxRuntime.jsx)(_lucideReactNative.ArrowLeft, { size: 20, color: "#000" })
                                }
                                ),/*#__PURE__*/
                                (0, _jsxRuntime.jsxs)(_reactNative.View, {
                                    style: { flex: 1, alignItems: 'center' }, children: [/*#__PURE__*/
                                        (0, _jsxRuntime.jsx)(_lucideReactNative.CheckCircle, { size: 32, color: "#16a34a", style: { marginBottom: 8 } }),/*#__PURE__*/
                                        (0, _jsxRuntime.jsx)(_reactNative.Text, { style: { fontSize: 20, fontWeight: 'bold', color: '#111827' }, children: t('ccTitle') || "Consultation Completed" }),/*#__PURE__*/
                                        (0, _jsxRuntime.jsx)(_reactNative.Text, { style: { color: '#6b7280', textAlign: 'center' }, children: t('ccSubtitle') || "Your medical consultation has been successfully completed" })]
                                }
                                )]
                        }
                ...
                (0, _jsxRuntime.jsxs)(_card.Card, {
                    style: styles.cardSpacing, children: [/*#__PURE__*/
                        (0, _jsxRuntime.jsx)(_card.CardHeader, {
                            children:/*#__PURE__*/
                                (0, _jsxRuntime.jsxs)(_card.CardTitle, {
                                    style: { flexDirection: 'row', alignItems: 'center', color: '#16a34a' }, children: [/*#__PURE__*/
                                        (0, _jsxRuntime.jsx)(_lucideReactNative.CheckCircle, { size: 20, color: "#16a34a", style: { marginRight: 8 } }),/*#__PURE__*/
                                        (0, _jsxRuntime.jsx)(_reactNative.Text, { children: t('ccSummary') || "Consultation Summary" })]
                                }
                                )
                        }
                        ...
                        (0, _jsxRuntime.jsxs)(_card.CardContent, {
                            style: { gap: 12 }, children: [/*#__PURE__*/
                                (0, _jsxRuntime.jsxs)(_reactNative.View, {
                                    style: styles.rowBetween, children: [/*#__PURE__*/
                                        (0, _jsxRuntime.jsxs)(_reactNative.View, {
                                            children: [/*#__PURE__*/
                                                (0, _jsxRuntime.jsx)(_reactNative.Text, { style: styles.label, children: t('ccDepartment') || "Department" }),/*#__PURE__*/
                                                (0, _jsxRuntime.jsx)(_reactNative.Text, { style: styles.value, children: visitData.department })]
                                        }
                                        ),/*#__PURE__*/
                                        (0, _jsxRuntime.jsxs)(_reactNative.View, {
                                            children: [/*#__PURE__*/
                                                (0, _jsxRuntime.jsx)(_reactNative.Text, { style: styles.label, children: t('ccDoctor') || "Doctor" }),/*#__PURE__*/
                                ...
                                (0, _jsxRuntime.jsxs)(_reactNative.View, {
                                    children: [/*#__PURE__*/
                                        (0, _jsxRuntime.jsx)(_reactNative.Text, { style: styles.label, children: t('ccDiagnosis') || "Diagnosis" }),/*#__PURE__*/
                                        (0, _jsxRuntime.jsx)(_reactNative.Text, { style: styles.value, children: visitData.diagnosis })]
                                }
                                ),/*#__PURE__*/
                                (0, _jsxRuntime.jsxs)(_reactNative.View, {
                                    children: [/*#__PURE__*/
                                        (0, _jsxRuntime.jsx)(_reactNative.Text, { style: styles.label, children: t('ccTreatment') || "Treatment" }),/*#__PURE__*/
                                ...
                                (0, _jsxRuntime.jsxs)(_reactNative.View, {
                                    children: [/*#__PURE__*/
                                        (0, _jsxRuntime.jsx)(_reactNative.Text, { style: styles.label, children: t('ccNotes') || "Additional Notes" }),/*#__PURE__*/
                ...
                (0, _jsxRuntime.jsxs)(_card.Card, {
                    style: styles.cardSpacing, children: [/*#__PURE__*/
                        (0, _jsxRuntime.jsx)(_card.CardHeader, {
                            children:/*#__PURE__*/
                                (0, _jsxRuntime.jsxs)(_card.CardTitle, {
                                    style: { flexDirection: 'row', alignItems: 'center', color: '#2563eb' }, children: [/*#__PURE__*/
                                        (0, _jsxRuntime.jsx)(_lucideReactNative.Pill, { size: 20, color: "#2563eb", style: { marginRight: 8 } }),/*#__PURE__*/
                                        (0, _jsxRuntime.jsxs)(_reactNative.Text, { children: [t('ccPrescriptions') || "Prescriptions", " (", visitData.prescriptions.length, ")"] })]
                                }
                                )
                        }
                        ),/*#__PURE__*/
                        (0, _jsxRuntime.jsx)(_card.CardContent, {
                            children:
                                visitData.prescriptions.map(function (presc, idx) {
                                    return (/*#__PURE__*/
                                        (0, _jsxRuntime.jsxs)(_reactNative.View, {
                                            style: styles.itemBox, children: [/*#__PURE__*/
                                                ...
                                                (0, _jsxRuntime.jsxs)(_reactNative.View, {
                                                    style: [styles.rowBetween, { marginTop: 8 }], children: [/*#__PURE__*/
                                                        (0, _jsxRuntime.jsxs)(_reactNative.Text, { style: { fontSize: 12, color: '#6b7280' }, children: [t('ccFreq') || "Freq", ": ", presc.frequency] }),/*#__PURE__*/
                                                        (0, _jsxRuntime.jsxs)(_reactNative.Text, { style: { fontSize: 12, color: '#6b7280' }, children: [t('ccDur') || "Dur", ": ", presc.duration] }),/*#__PURE__*/
                                                ...
                                                (0, _jsxRuntime.jsx)(_reactNative.Text, { style: { marginTop: 8, fontSize: 12, fontStyle: 'italic', color: '#4b5563' }, children: presc.instructions })]
                                        }, idx
                                        ));
                                }
                                )
                ...
                (0, _jsxRuntime.jsxs)(_card.Card, {
                    style: styles.cardSpacing, children: [/*#__PURE__*/
                        (0, _jsxRuntime.jsx)(_card.CardHeader, {
                            children:/*#__PURE__*/
                                (0, _jsxRuntime.jsxs)(_card.CardTitle, {
                                    style: { flexDirection: 'row', alignItems: 'center', color: '#9333ea' }, children: [/*#__PURE__*/
                                        (0, _jsxRuntime.jsx)(_lucideReactNative.FlaskConical, { size: 20, color: "#9333ea", style: { marginRight: 8 } }),/*#__PURE__*/
                                        (0, _jsxRuntime.jsxs)(_reactNative.Text, { children: [t('ccLabTests') || "Lab Tests Ordered", " (", visitData.labTests.length, ")"] })]
                                }
                                )
                        }
                        ),/*#__PURE__*/
                        (0, _jsxRuntime.jsx)(_card.CardContent, {
                            children:
                                visitData.labTests.map(function (lab, idx) {
                                    return (/*#__PURE__*/
                                        (0, _jsxRuntime.jsxs)(_reactNative.View, {
                                            style: [styles.itemBox, { backgroundColor: '#faf5ff', borderColor: '#e9d5ff' }], children: [/*#__PURE__*/
                                                ...
                                                (0, _jsxRuntime.jsxs)(_reactNative.View, {
                                                    style: [styles.rowBetween, { marginTop: 8 }], children: [/*#__PURE__*/
                                                        (0, _jsxRuntime.jsxs)(_reactNative.Text, { style: { fontSize: 12, color: '#6b7280' }, children: [t('ccOrderedBy') || "Ordered by", ": ", lab.orderedBy] }),/*#__PURE__*/
                ...
                (0, _jsxRuntime.jsxs)(_reactNative.View, {
                    style: { gap: 12, marginTop: 16 }, children: [/*#__PURE__*/
                        (0, _jsxRuntime.jsxs)(_button.Button, {
                            onPress: handleDownloadToken, style: { backgroundColor: '#2563eb' }, children: [/*#__PURE__*/
                                (0, _jsxRuntime.jsx)(_lucideReactNative.Download, { size: 16, color: "#fff", style: { marginRight: 8 } }),/*#__PURE__*/
                                (0, _jsxRuntime.jsx)(_reactNative.Text, { style: { color: '#fff', fontWeight: 'bold' }, children: t('ccDownload') || "Download Token Details" })]
                        }
                        ),/*#__PURE__*/
                        (0, _jsxRuntime.jsxs)(_button.Button, {
                            variant: "outline", onPress: handleBackToDashboard, children: [/*#__PURE__*/
                                (0, _jsxRuntime.jsx)(_lucideReactNative.FileText, { size: 16, color: "#000", style: { marginRight: 8 } }),/*#__PURE__*/
                                (0, _jsxRuntime.jsx)(_reactNative.Text, { children: t('ccBackDashboard') || "Back to Dashboard" })]
                        }
                        )]
                }
                )]
