...
var Toggle=exports.Toggle=function Toggle(_ref){
  var pressed=_ref.pressed,onPressedChange=_ref.onPressedChange,children=_ref.children,style=_ref.style,_ref$variant=_ref.variant,variant=_ref$variant===void 0?'default':_ref$variant;
  ...
  return (
    (0,_jsxRuntime.jsx)(_reactNative.TouchableOpacity,{
      ...
      activeOpacity:0.7,
      onPress:function onPress(){return onPressedChange&&onPressedChange(!pressed);},
      children: content
    })
  );
};
